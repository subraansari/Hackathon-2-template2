          ...
          <div className="flex flex-col md:flex-row">
            <div className="w-full md:w-[720px] h-auto px-4 md:px-12 py-8 flex flex-col justify-between">
              <div>
                ...
                <h1 className="py-6 text-lg md:text-xl">
                  When we started Avion, the idea was simple. Make high quality<br />
            ...
            <div className="w-full md:w-[890px] h-auto">
              <Image
                ...
                width={500}
                alt="chair"
                className="w-full h-full object-cover transition-transform duration-300 ease-in-out hover:scale-105 hover:rotate-1"
              />
            </div>
          </div>
        </div>
